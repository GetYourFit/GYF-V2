...
class FootwearCompatibility:
    ...
    style: FootwearStyle
    formality_levels: FrozenSet[FormalityLevel]
...
COMPATIBILITY_MATRIX: Tuple[FootwearCompatibility, ...] = (
    ...
    FootwearCompatibility(
        ...
        formality_levels=frozenset([FormalityLevel.VERY_CASUAL, FormalityLevel.CASUAL]),
        appropriate_occasions=frozenset(
            [OccasionType.ATHLEISURE, OccasionType.CASUAL, OccasionType.VACATION]
        ),
    ...
    FootwearCompatibility(
        ...
        formality_levels=frozenset(
            [FormalityLevel.VERY_CASUAL, FormalityLevel.CASUAL, FormalityLevel.SMART_CASUAL]
        ),
        appropriate_occasions=frozenset(
            [OccasionType.CASUAL, OccasionType.VACATION, OccasionType.PARTY]
        ),
    ...
    FootwearCompatibility(
        ...
        formality_levels=frozenset(
            [FormalityLevel.BUSINESS_CASUAL, FormalityLevel.FORMAL, FormalityLevel.BLACK_TIE]
        ),
        appropriate_occasions=frozenset(
            [OccasionType.BUSINESS, OccasionType.FORMAL, OccasionType.WEDDING]
        ),
    ...
    FootwearCompatibility(
        ...
        formality_levels=frozenset(
            [FormalityLevel.SMART_CASUAL, FormalityLevel.BUSINESS_CASUAL, FormalityLevel.FORMAL]
        ),
        appropriate_occasions=frozenset(
            [OccasionType.CASUAL, OccasionType.BUSINESS, OccasionType.PARTY, OccasionType.WEDDING]
        ),
    ...
    FootwearCompatibility(
        ...
        formality_levels=frozenset(
            [FormalityLevel.CASUAL, FormalityLevel.SMART_CASUAL, FormalityLevel.BUSINESS_CASUAL]
        ),
        appropriate_occasions=frozenset(
            [OccasionType.CASUAL, OccasionType.BUSINESS, OccasionType.PARTY]
        ),
        compatible_tops=frozenset(["shirt", "blouse", "sweater", "t_shirt"]),
    ...
    FootwearCompatibility(
        ...
        appropriate_occasions=frozenset(
            [OccasionType.CASUAL, OccasionType.VACATION, OccasionType.PARTY, OccasionType.WEDDING]
        ),
    ...
    FootwearCompatibility(
        ...
        formality_levels=frozenset([FormalityLevel.VERY_CASUAL]),
        appropriate_occasions=frozenset(
            [OccasionType.LOUNGEWEAR, OccasionType.CASUAL, OccasionType.VACATION]
        ),
        compatible_tops=frozenset(["t_shirt", "blouse"]),
        compatible_bottoms=frozenset(["shorts", "jeans"]),
        incompatible_with=frozenset(
            ["shirt", "dress", "saree", "lehenga", "anarkali", "sherwani", "trousers"]
        ),
    ),
    # Heels
    FootwearCompatibility(
        ...
        appropriate_occasions=frozenset(
            [OccasionType.BUSINESS, OccasionType.FORMAL, OccasionType.WEDDING, OccasionType.PARTY]
        ),
        compatible_tops=frozenset(["shirt", "blouse", "sweater"]),
    ...
    FootwearCompatibility(
        ...
        appropriate_occasions=frozenset(
            [OccasionType.CASUAL, OccasionType.VACATION, OccasionType.PARTY, OccasionType.BUSINESS]
        ),
        compatible_tops=frozenset(["shirt", "blouse", "t_shirt", "sweater"]),
    ...
    FootwearCompatibility(
        ...
        formality_levels=frozenset(
            [FormalityLevel.CASUAL, FormalityLevel.SMART_CASUAL, FormalityLevel.FORMAL]
        ),
        appropriate_occasions=frozenset(
            [OccasionType.CASUAL, OccasionType.FESTIVE, OccasionType.WEDDING, OccasionType.FORMAL]
        ),
    ...
    FootwearCompatibility(
        ...
        incompatible_with=frozenset(
            ["shirt", "dress", "saree", "lehenga", "anarkali", "sherwani", "jeans"]
        ),
        indoor_only=True,
    ),
    FootwearCompatibility(
...
def is_compatible_outfit(
    ...
    if bottom_category is None:  # This is a full_body garment
        if (
            top_category not in compat.compatible_bottoms and compat.compatible_bottoms
        ):  # Only check if rules exist
            return False
    else:
        # Separate top and bottom
        if (
            top_category not in compat.compatible_tops and compat.compatible_tops
        ):  # Only check if rules exist
            return False

        if (
            bottom_category not in compat.compatible_bottoms and compat.compatible_bottoms
        ):  # Only check if rules exist
            return False
...
def validate_footwear_outfit(
    ...
    if not is_valid:
        ...
        if compat and compat.indoor_only:
            return (
                False,
                f"{footwear_style.value.replace('_', ' ').title()} are only suitable for indoor/loungewear",
            )
        elif compat and bottom_category in compat.incompatible_with:
            return (
                False,
                f"{footwear_style.value.replace('_', ' ').title()} don't pair well with {bottom_category.replace('_', ' ')}",
            )
        elif compat and top_category in compat.incompatible_with:
            return (
                False,
                f"{footwear_style.value.replace('_', ' ').title()} don't pair well with {top_category.replace('_', ' ')}",
            )
        else:
            return (
                False,
                f"{footwear_style.value.replace('_', ' ').title()} are not appropriate for {occasion} occasions",
            )
