    ...
    <div style={{ display: "flex", flexDirection: "column", gap: "0.875rem" }}>
      ...
      <label
        ...
        style={{
          ...
          background: dragActive ? "rgba(255,255,255,0.04)" : "rgba(255,255,255,0.03)",
          border: `1px dashed ${dragActive ? "var(--secondary)" : "rgba(255,255,255,0.12)"}`,
          cursor: "pointer",
          transition: "all 0.2s",
          textAlign: "center",
      ...
      <div style={{ display: "flex", alignItems: "center", gap: "0.75rem" }}>
        <motion.button
          ...
          style={{
            ...
            height: "40px",
            padding: "0 1rem",
            background: file && !busy ? "var(--primary)" : "rgba(255,255,255,0.06)",
